 ...
 * exchanges the code for tokens (in-process via `localAuthServerFetch`)
 * and stores them in the server-side session; `/auth/session` reports who
 * is signed in; `/auth/logout` clears the session.
 *
 * @module
 */
